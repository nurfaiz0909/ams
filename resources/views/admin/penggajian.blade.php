...
@section('title', 'Penggajian Karyawan AMS')
...
<div class="container-fluid">
    <div class="row align-middle justify-content-between mx-3">
        <div class="col-6">
            <!-- Page Heading -->
            <h1 class="h3 mb-2 text-gray-800">Data Penggajian Karyawan AMS</h1>
        </div>
                                        ...
                                        <div class="modal-body text-dark">
                                            <div class="row">
                                                <div class="col-9 pl-5">
                                                    ...
                                                    <h2 class="text-left text-dark mb-0 mt-1">
                                                        Attendance Management System
                                                    </h2>
                                                </div>
                                                <div class="col-3 pr-4">
                                                    <img src="{{ asset('img/logo2.png') }}" height="80px;">
                                                </div>
                                            </div>
